                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        if(isset($_POST['sub']))
                                        {
                                            ...
                                            if($error=='') {
                                                $charger_id = preg_replace('/\s/', '', $_REQUEST['charger_id']);
                                                $charger = new FetchData();
                                                $charger->set_where(array('is_deleted' => 0, 'charger_id' => $charger_id));
                                                $chargerFind = $charger->fetch_data('charger', array('id'));
                                                if (mysqli_num_rows($chargerFind) > 0) {
                                                    echo "<p style='color:red'>This Charger Is Already Added</p>";
                                                }
                                                else {
                                                    $addDetails = new AddDetails();
                                                    $res = $addDetails->add_details('charger',$params);
                                                    if($res == false){
                                                        echo "<p style='color:red'>Something Went Wrong. Please Try Again Later</p>";
                                                    }
                                                    else{
                                                        echo"<script>alert('Charger Added');window.location.href='index.php?action=view_charger';</script>";
                                                    }
                                                }
                                            }
                                            else{
                                                ...
                                                <form method="post" name="form" id="form">
                                                    ...
                                                    <div class="col-md-6" style="float:right">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="chargegroup_id" placeholder="Charger Group" value="<?php if(isset($_POST['chargegroup_id'])){ echo $_POST['chargegroup_id']; }?>" required>
