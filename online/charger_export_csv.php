...
//	  $conval1 = array('0'); //array for value of condition you need if any
	  //if charger_id serached
		  ...
		  if ($_REQUEST['form_chargerid'] != '') {
              ...
              $conkey1['charger_id']=(mysqli_real_escape_string($con, $_REQUEST['form_chargerid']));
	  ...
	  //if station id searched
			  ...
			  $conkey1['station_id'] =  (mysqli_real_escape_string($con, $_REQUEST['station_id'])); //array for value of condition you need if any
			  $row1 = Selectdata('charger', $field1, $conkey1);
		  }
	  ...
	  //if site searched
		  ...
		  if ($_REQUEST['site'] != '') {
			  $conkey1['site_id'] = (mysqli_real_escape_string($con, $_REQUEST['site'])); //array for value of condition you need if any
              $row1 = Selectdata('charger', $field1, $conkey1);
		  }
	  ...
	  //if charger group searched
			  ...
			  $conkey1['chargegroup_id'] = (mysqli_real_escape_string($con, $_REQUEST['chargegroup'])); //array for value of condition you need if any
			  $row1 = Selectdata('charger', $field1, $conkey1);
		  }
	  ...
	  //if connector id searched
			  ...
			  $conkey1['connector_id'] = (mysqli_real_escape_string($con, $_REQUEST['connector_id'])); //array for value of condition you need if any
			  $row1 = Selectdata('charger', $field1, $conkey1);
		  }
	  ...
	  //if connector capabilities searched
			  ...
			  $conkey1['charger_capability_id'] = (mysqli_real_escape_string($con, $_REQUEST['connector_capabilities'])); //array for value of condition you need if any
			  $row1 = Selectdata('charger', $field1, $conkey1);
		  }
	  ...
	  //if transacrion type searched
			  ...
			  $conkey1['transaction_type'] = (mysqli_real_escape_string($con, $_REQUEST['transaction_type'])); //array for value of condition you need if any
			  $row1 = Selectdata('charger', $field1, $conkey1);
		  }
	  ...
	  //if connector type searched
			  ...
			  $conkey1['connector_type'] = (mysqli_real_escape_string($con, $_REQUEST['connector_type'])); //array for value of condition you need if any
			  $row1 = Selectdata('charger', $field1, $conkey1);
		  }
	  ...
	  //if connector_category searched
			  ...
			  $conkey1['connector_category'] =(mysqli_real_escape_string($con, $_POST['connector_category'])); //array for value of condition you need if any
		 	  $row1 = Selectdata('charger', $field1, $conkey1);	
		  }
