                                    ...
                                    <div class="card-header">
                                        ...
                                        <form method="post">
                                            <div class="form-row " style="margin:0; padding:5px;">
                                                <!--charger id-->
                                                <?php if(!isset($SelClms1) || (isset($SelClms1) && in_array('charger_id',$SelClms1))){?>
                                                ...
                                                <?php } if(!isset($SelClms1) || (isset($SelClms1) && in_array('station_id',$SelClms1))){?>
                                                <!--Station ID-->
                                                <div class="form-group col-md-2">
                                                ...
                                                <?php } if(!isset($SelClms1) || (isset($SelClms1) && in_array('site',$SelClms1))){?>
                                                ...
                                                <?php } if(!isset($SelClms1) || (isset($SelClms1) && in_array('charger_group',$SelClms1))){?>
                                                <!--site  fetched from evse_groups table-->
                                                <div class="form-group col-md-2">
                                                    <label for="exampleInputEmail1">Charger Group</label>
                                                    <input type="text" class="form-control" name="chargegroup" aria-describedby="emailHelp" placeholder="Charger Group" value="<?php if(isset($_POST['chargegroup'])){ echo $_POST['chargegroup'];} ?>">
...
<!--                                                    </select>-->
                                                ...
                                                <div class="form-group col-md-2">
                                                    ...
                                                    <select class="form-control" name="transaction_type" aria-describedby="emailHelp">
                                                        ...
                                                        $chargertsql = $chrger_t->fetch_data('transaction_type', array('id', 'transaction_name'));
                                                        if (mysqli_num_rows($chargertsql)) {
                                                            while ($row_charegrt = mysqli_fetch_assoc($chargertsql)) {
                                                                ...
                                                                echo '>' . ucwords($row_charegrt['transaction_name']) . '</option>';
                                                            }
                                                        }
                                                        ?>
                                                    </select>
                                                ...
                                                <?php if(!isset($SelClms1) || (isset($SelClms1) && in_array('connector_type',$SelClms1))){?>
                                                ...
                                                <?php } if(!isset($SelClms1) || (isset($SelClms1) && in_array('connector_category',$SelClms1))){?>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped">
                                                ...
                                                <tr>
                                                    ...
                                                    <?php if(!isset($SelClms1) || (isset($SelClms1) && in_array('charger_id',$SelClms1))){?>
                                                    <th>Charger Id</th>
                                                    <?php } if(!isset($SelClms1) || (isset($SelClms1) && in_array('ocpp_chargebox_id',$SelClms1))){?>
                                                    ...
                                                    <?php } if(!isset($SelClms1) || (isset($SelClms1) && in_array('installed_date',$SelClms1))){?>
                                                    <th>Installed Date</th>
                                                    <?php } if(!isset($SelClms1) || (isset($SelClms1) && in_array('lat_long',$SelClms1))){?>
                                                    <th>Lat/Long</th>
                                                    <?php }?>
                                                    <th>Action</th>
                                                </tr>
                                                ...
                                                $querystring = array('c.*','s.site_name','tran_t.transaction_name','charger_cp.charge_cp_name');
                                                $get_charger = $charger->fetch_data('charger c',$querystring);

                                                $get_chargernum=mysqli_num_rows($get_charger);
                                                if($get_chargernum==0){
                                                    echo"<script>window.location.href='index.php?action=view_charger';</script>";
                                                }
                                                else{
                                                    ...
                                                    { ?>
                                                        <tr class="text-white" id="div<?=$row['charger_id'];?>" <?php echo'style="background:#9c9595"'; /*if($i==1){ echo'style="background:#ffa600"';} elseif($i==2){ echo'style="background:#204406"'; }elseif($i==3){ echo'style="background:#909090"'; }elseif($i==4){ echo'style="background:#c3150f"'; }else{ echo'style="background:#9c9595"'; }*/?>>
                                                            ...
                                                            <?php } if(!isset($SelClms1) || (isset($SelClms1) && in_array('charger_group',$SelClms1))){?>
                                                            <td><?=ucwords($row['chargegroup_id']);?></td>
                                                            <?php } if(!isset($SelClms1) || (isset($SelClms1) && in_array('connector_type',$SelClms1))){?>
                                                            ...
                                                            <?php }?>
                                                            <td>
                                                                <a href="index.php?action=edit_charger&id=<?=$row['id'];?>" > &nbsp;&nbsp;<i class="fas fa-edit"></i></a>
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                for(var i=0; i<len; i++) {
                    ...
                    {
                        $('#div'+id).css('background', '#c3150f');
                    }
                    else if(status=='Charging')
                    {
                        $('#div'+id).css('background', '#ffa600');
                    }
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
                    ...
                    <table class="table">
                      <form action="" method="POST">
                        ...
                        <tr style="border-bottom:solid 1px #ccc">
                            ...
                            <td align="right"><input type="checkbox" <?php  if(!isset($SelClms1) || (isset($SelClms1) && in_array('charger_id',$SelClms1))) echo 'checked' ?> name="charger_id" /></td>
                            <!--<td align="right"><img src="assets/images/lock.png" style="max-width:18px;"></td>-->
                        </tr>
                        <tr style="border-bottom:solid 1px #ccc">
                            <td height="20" width="50%">OCPP CHARGEBOX ID</td>
                            <td align="right"><input type="checkbox" <?php  if(!isset($SelClms1) || (isset($SelClms1) && in_array('ocpp_chargebox_id',$SelClms1))) echo 'checked' ?> name="ocpp_chargebox_id" /></td>
                        </tr>
                        <tr style="border-bottom:solid 1px #ccc">
                            <td height="20" width="50%">STATION ID</td>
                            <td align="right"><input type="checkbox" <?php  if(!isset($SelClms1) || (isset($SelClms1) && in_array('station_id',$SelClms1))) echo 'checked' ?> name="station_id" /></td>
                        </tr>
                        <tr style="border-bottom:solid 1px #ccc">
                            <td height="20" width="50%">SITE</td>
                            <td align="right"><input type="checkbox" <?php  if(!isset($SelClms1) || (isset($SelClms1) && in_array('site',$SelClms1))) echo 'checked' ?> name="site" /></td>
                        </tr>
                        <tr style="border-bottom:solid 1px #ccc">
                            <td height="20" width="50%">Charge Group</td>
                            <td align="right"><input type="checkbox" <?php  if(!isset($SelClms1) || (isset($SelClms1) && in_array('charge_group',$SelClms1))) echo 'checked' ?> name="charge_group" /></td>
                        </tr>
                        <tr style="border-bottom:solid 1px #ccc">
                            <td height="20" width="50%">Connector Type</td>
                            <td align="right"><input type="checkbox" <?php  if(!isset($SelClms1) || (isset($SelClms1) && in_array('connector_type',$SelClms1))) echo 'checked' ?> name="connector_type" /></td>
                        </tr>
                        <tr style="border-bottom:solid 1px #ccc">
                            <td height="20" width="50%">Connector Category</td>
                            <td align="right"><input type="checkbox" <?php  if(!isset($SelClms1) || (isset($SelClms1) && in_array('connector_category',$SelClms1))) echo 'checked' ?> name="connector_category" /></td>
                        </tr>
                        <tr style="border-bottom:solid 1px #ccc">
                            <td height="20" width="50%">Installed Date</td>
                            <td align="right"><input type="checkbox" <?php  if(!isset($SelClms1) || (isset($SelClms1) && in_array('installed_date',$SelClms1))) echo 'checked' ?> name="installed_date" /></td>
                        </tr>
                        <tr style="border-bottom:solid 1px #ccc">
                            <td height="20" width="50%">Lat/Long</td>
                            <td align="right"><input type="checkbox" <?php  if(!isset($SelClms1) || (isset($SelClms1) && in_array('lat_long',$SelClms1))) echo 'checked' ?> name="lat_long" /></td>
                        </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class="modal-footer">
                ...
                <button type="submit"  name="manage_charger" class="btn btn-primary" >Save</button>
			</form>	
            </div>
        </div>
    </div>
